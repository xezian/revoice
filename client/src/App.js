...
class App extends Component {
  state = {
    emojiState: '❤',
    message: 'revoice is a simple + fun game to enjoy with (or without) your friends',
    directions: ['to get started, click record anew or browse'],
    colors: ['green','orange','purple','goldenrod','silver','black','maroon','blue','red']
  }
  switchEmoji = (emoji) => {
      ...
      <div className="App">
        ...
        <ul className="directions">
        {
          this.state.directions.map((direction, key) => {
            return <li key={key} style={{color:this.state.colors[key]}}>{direction}</li>
